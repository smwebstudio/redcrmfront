import { Button, Cascader, Checkbox, Col, Form, Input, Modal, Row, Select } from "antd";
        ...
        <>
            <Form form={form} onFinish={onFinish} action="/search" method="get"
                ...
                <Row>
                    ...
                    <Col xs={12} sm={4} className="field-item pl-3 pr-3">
                        <Button
                            className="btn  bg-gray-800 text-white  w-100" size="large" onClick={showModal}>
                            Պատվիրել զանգ
                        </Button>
                    </Col>
                </Row>
            ...
            <Modal
                ...
                >
                    <Row  className={'mb-10'}>
                        <Col xs={16}>
                            <SmallParagraph className={'mb-10'}>Ողջույն հարգելի հաճախորդ: Այս հայտը լրացնելուց հետո մեր մասնագետները կկապվեն Ձեզ հետ։</SmallParagraph>
                        </Col>
                    </Row>
                    <Row gutter={24}>
                        ...
                        <Col xs={24}>
                            <Checkbox>
                                <SmallParagraph>Համաձայն եմ տրամադրել անձնական տվյալներս</SmallParagraph>
                            </Checkbox>
                        </Col>
