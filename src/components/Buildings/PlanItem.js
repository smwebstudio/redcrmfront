        ...
        <div key={item.id} className={" mb-10 border-solid  border-gray-200 border"}>
            {item.saled === 1 &&
                <div>
                    ...
                    <img src={"/assets/developers/saled.png"} style={{
                        zIndex: "99",
                        width: "199px",
                        height: "77px",
                        minHeight: "50px",
                ...
                <div className="details bg-transparent border-solid  border-gray-200 border-t">
                    <Row className="mb-3">
                        ...
                        <Col xs={12} className="text-right justify-end content-end flex flex-row">
                            <span className={"cursor-pointer"} key={"compare_" + item.id} onClick={() => compare(item)}><img
                                src={"/assets/img/svg/compare.svg"} alt="logo" /></span>
                            <span className={"ml-4 cursor-pointer"} key={"add_to_favorites_" + item.id}><img
                                src={"/assets/img/svg/favorites.svg"} alt="logo" /></span>
                        </Col>
                    </Row>
                    ...
                    <ul className="info-list">
                        {item.room_count &&
                            <li className="mr-4"><img src={"/assets/img/svg/doors.svg"}
                                                      alt="logo" />{item.room_count}
                            </li>
                        }

                        {item.floor &&
                            <li className="mr-4"><img src={"/assets/img/svg/floor.svg"}
                                                      alt="logo" />{item.floor} / {item.building_floor_count}</li>
                        }
