        ...
        <div className="">
            <div key={item.id} className={"mb-5"}>
                <div className="single-feature">
                    <div className="thumb">
                        <Link href={"developers/" + item.id} style={{ width: "100%" }}>
                    ...
                    <div className="details">
                        ...
                        <Row>
                            <Col xs={24}>
                                <DarkHeading3 style={{minHeight: '50px'}}>{item.name_arm}</DarkHeading3>
                            </Col>
                            <Col xs={24}>
                                <SmallParagraph className="address d-flex mt-2">
                                    <span><img src={"/assets/img/svg/location.svg"} alt="logo" /></span>
                                    <SmallParagraph className="ml-2">{item.full_address}</SmallParagraph>
                                </SmallParagraph>
                            </Col>
                        </Row>
