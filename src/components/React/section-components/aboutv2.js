            ...
            <div className="row">
              <div className="col-lg-5 align-self-center">
                <div className="section-title mb-lg-0">
                  ...
                  <p>{ data.content }</p>
                  <Link className="btn-view-all-2" to={ data.url } legacyBehavior>{ data.btn_text } <i className="la la-long-arrow-right" /></Link>
                </div>
              </div>
              ...
              >
                ...
                { data.featureswithicon.map( ( item, i ) =>
                  ...
                  <div key={ i } className="col-md-4 col-sm-6">
                    <Link className="cat-single text-center" legacyBehavior>
