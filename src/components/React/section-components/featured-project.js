                    ...
                    <div className="col-lg-12 col-sm-12">
                      <div className="single-feature">
                        ...
                        <div className="details">
                         ...
                         <h6 className="title readeal-top"><Link href="/property-details">{ item.titleThirdItem }</Link></h6>
                          ...
                          <ul className="contact-list">
                            ...
                            <li className="readeal-top"><Link className="btn btn-yellow" href="/property-details">View Details</Link></li>
                          </ul>
                        </div>
                      </div>
                    </div>
