              ...
              <div className="col-xl-6 col-lg-8">
                <div className="single-leading-feature">
                  ...
                  <div className="details">
                    <h4 className="title readeal-top"><Link href={ data.firstitem.url  }><a>{ data.firstitem.title }</a></Link></h4>
                  ...
                  <div key={ i } className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className="single-feature">
                      ...
                      <div className="details">
                        ...
                        <h6 className="title readeal-top"><Link href={ item.url }><a>{ item.title }</a></Link></h6>
                        ...
                        <ul className="contact-list">
                          ...
                          <li className="readeal-top"><Link className="btn btn-yellow" href={item.url}><a>View Details</a></Link></li>
                        </ul>
                      </div>
                    </div>
                  </div>
