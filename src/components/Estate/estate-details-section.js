                ...
                <div className="container">
                    <div className="row ">
                        ...
                        <div className="col-12 mb-5">
                            <img className="mr-2" src={"/assets/img/svg/location.svg"} alt="location" />Վաճառվում է 3 սենյականոց բնակարան {estate?.full_address}
                        </div>
                        ...
                        <div className="col-xl-3 col-lg-4">
                            <div className="widget widget-owner-info mt-lg-0 mt-5">
                                <div className="owner-info text-center">
                                    <div className="thumb">
                                        <img src={estateData.data?.image} alt={ imagealt } />
                                    </div>
