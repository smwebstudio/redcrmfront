...
const EstatesGoogleMapNew = (props) => {
    ...
    const onGoogleApiLoaded = (map) => {
        const { drawingMode, drawFreeHandMode } = { drawingMode, drawFreeHandMode };
    ...
    return (
        <>
            ...
            {mapLoaded && (
                <div className={"controls-container absolute z-30 left-50 top-0"}>
                    <div className="center">
                        <button className="btn-control" onClick={handleDrawingMode}>
