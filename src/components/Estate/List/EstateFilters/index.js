...
import StyledEstateFilters, {
    FilterGlobalStyles,
} from '@/components/Estate/List/EstateFilters/style'
...
const EstateFilters = ({
    ...
    const [showAdditionalFilters, setShowAdditionalFilters] = useState(
        openAdditionalFilters ? openAdditionalFilters : false,
    )
                        ...
                        <Row justify={'space-between'} gutter={8} wrap={false}>
                            ...
                            <Col>
                                <Form.Item name="estate_type_id">
                                    <FilterSelect
                                        placeholder={t('label.estateType')}
