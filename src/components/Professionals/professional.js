    ...
    return (
        <div className="professional-card flex flex-row pt-4 pb-4">
            ...
            <div className="professional-info p-2 flex flex-col justify-content-center">
                ...
                <p className="flex mb-1 justify-content-start text-dark"><img className="mr-2" src={publicUrl + "assets/img/svg/envelope.svg"} /> <span className="align-self-center">{professional.email}</span></p>
                <p className="flex justify-content-start text-dark"><img className="mr-2" src={publicUrl + "assets/img/svg/mobile.svg"} /><span className="align-self-center">{professional.phone_1}</span></p>
            </div>
        </div>
    );
}
