...
export const BlogBanner = ({ lng }) => {
    ...
    return (
        <div className="pt-5 mb-3 mb-sm-5" style={inlineStyle}>
                        ...
                        <div className="col-12">
                            <div className="banner-inner text-center align-self-center mt-5">
                                ...
                                <h6 className="title text-center text-white mb-5 pl-5 pr-5">
                                    We are ready and willing to solve your
                                    problems within our services in the real
                                    estate market, listen and accept your
                                    opinion about good work and criticize our
                                    team for omissions.
                                </h6>
                            </div>
                        </div>
